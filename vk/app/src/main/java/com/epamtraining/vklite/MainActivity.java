...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra(AuthHelper.TOKEN)) {
            String mToken = getIntent().getStringExtra(AuthHelper.TOKEN);
            Api.setToken((VKApplication) (getApplication()), mToken);
        } else {
            //It's unclear why token could be null here
            //Auth  errors are handled in auth package.
            ErrorHelper.showError(this, R.string.auth_error);
            finish();
        }
    ...
    private void initNavigationDrawer() {
        mFragmentTypes = FragmentType.values();//
    }
